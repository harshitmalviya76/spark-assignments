...
FILE_PATH= "C:/Users/jayes/OneDrive/Desktop/spark/Weather.csv"
coloumns=['code','province','date','avg_temp','min_temp','max_temp','precipitation','max_wind_speed','most_wind_direction','avg_relative_humidity']
